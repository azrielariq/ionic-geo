...
PlacePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-place',template:/*ion-inline-start:"E:\ionic\placeApp\src\pages\place\place.html"*/'<!--\n  Generated template for the PlacePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n    <ion-navbar>\n        <ion-title>Place</ion-title>\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n    <sebm-google-map [latitude]="lat" [longitude]="lng">\n\n    </sebm-google-map>\n    <button ion-button block (click)="onDismiss()">Dismiss</button>\n</ion-content>'/*ion-inline-end:"E:\ionic\placeApp\src\pages\place\place.html"*/,
    }),
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"E:\ionic\placeApp\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"E:\ionic\placeApp\src\app\app.html"*/
    }),
